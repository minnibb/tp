...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_CHARLES = "Charles Bee";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_PHONE_CHARLES = "33333333";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMAIL_CHARLES = "charles@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_ADDRESS_CHARLES = VALID_ADDRESS_AMY;
    public static final String VALID_ROLE_AMY = "Student";
    public static final String VALID_ROLE_BOB = "Staff";
    public static final String VALID_ROLE_CHARLES = "Parent";
    public static final String VALID_GRADE_AMY = "Sec 1";
    public static final String VALID_CLASS_AMY = "1A";
    public static final String VALID_PARENT_AMY = VALID_NAME_CHARLES;
    public static final String VALID_PARENT_PHONE_AMY = VALID_PHONE_CHARLES;
    public static final String VALID_CHILD_CHARLES = VALID_NAME_AMY;
    public static final String VALID_CHILD_PHONE_CHARLES = VALID_PHONE_AMY;
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final boolean VALID_FAVOURITE_AMY = false;
    public static final boolean VALID_FAVOURITE_BOB = false;
    public static final boolean VALID_FAVOURITE_CHARLES = false;
    public static final boolean VALID_FAVOURITE = true;
    ...
    public static final String EMAIL_DESC_CHARLES = " " + PREFIX_EMAIL + VALID_EMAIL_CHARLES;
    ...
    public static final String ROLE_DESC_CHARLES = " " + PREFIX_ROLE + VALID_ROLE_CHARLES;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withRole(VALID_ROLE_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withRole(VALID_ROLE_AMY).build();
    }
