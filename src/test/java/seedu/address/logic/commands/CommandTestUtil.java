...
public class CommandTestUtil {
    ...
    public static final String VALID_PARENT_AMY = "Charles Bee";
    ...
    public static final String PARENT_DESC_AMY = " " + PREFIX_PARENT + VALID_PARENT_AMY;
    ...
    public static final String INVALID_PARENT_DESC = " " + PREFIX_PARENT + "James&"; // '&' not allowed in names
